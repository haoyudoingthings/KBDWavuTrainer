...
![KBDWavuTrainerShowcase](KBDWavuTrainerShowcase.gif)
...
- **60 FPS poll** → read XInput state → **map** to 8 directions (b, f, u, d, db, df, ub, uf) or neutral (n).
...
- **Pattern matcher**: Sliding window over the tail of history; matches KBD (e.g. b, n, b, db, b, n, b, db, …) and wavu (e.g. f, n, d, df, n, f, n, d, df, …). On match, updates streaks and frequency.
